        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-14 pl-12 pr-4 bg-slate-50/50 border-2 border-slate-200 rounded-2xl focus:border-black focus:outline-none focus:ring-4 focus:ring-black/10"
              required
            />
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-14 pl-12 pr-14 bg-slate-50/50 border-2 border-slate-200 rounded-2xl focus:border-black focus:outline-none focus:ring-4 focus:ring-black/10"
              required
            />
            <button
              type="button"
