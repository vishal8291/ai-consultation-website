...
export default function AdminLogin() {
  ...
  return (
    <div className="tone-black min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="tone-white relative bg-white/80 backdrop-blur-xl shadow-2xl rounded-3xl p-10 w-full max-w-md border border-white/20">
        {/* Header */}
        ...
        <form onSubmit={login} className="space-y-6">
          ...
          <div className="relative">
            <input
              ...
              className="w-full h-14 px-4 pl-12 pr-14 bg-slate-50/50 border-2 border-slate-200 rounded-2xl text-lg placeholder-slate-400 focus:border-black focus:outline-none focus:ring-4 focus:ring-black/10 transition-all duration-300 shadow-sm hover:shadow-md"
              placeholder="••••••••"
              value={password}
