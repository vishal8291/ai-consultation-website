        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 text-slate-700 text-sm leading-relaxed">
          ...
          <div className="space-y-4 border-b border-slate-200 pb-6">
            ...
            <ul className="space-y-3 list-disc pl-5">
              ...
              <li>
                <strong>Timeline Start Criteria:</strong> The project delivery timeline, agreed with you before work starts, officially begins after we receive your complete text content, brand assets, and logo files.
              </li>
              <li>
