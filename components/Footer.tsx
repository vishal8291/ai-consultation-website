    ...
    <footer className="bg-slate-900 text-white border-t border-slate-800 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4 md:col-span-1">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-black text-white">
                vishal<span className="text-yellow-400 font-extrabold">.buildss</span>
              </span>
            </div>
            <p className="text-xs text-slate-400 leading-relaxed">
              Bespoke website design packages (Launch, Business & Automate) & AI workflow automation systems engineered by Vishal Tiwari.
            </p>
            ...
            <div className="flex items-center space-x-3 pt-2">
              <a
                ...
                className="w-8 h-8 rounded-xl bg-slate-800 hover:bg-yellow-400 hover:text-black text-yellow-400 flex items-center justify-center transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-slate-400 font-semibold">
              <li><a href="/#pricing" className="hover:text-yellow-400 transition-colors">Launch (₹12,000 / $150)</a></li>
              <li><a href="/#pricing" className="hover:text-yellow-400 transition-colors">Business (₹30,000 / $375)</a></li>
              <li><a href="/#pricing" className="hover:text-yellow-400 transition-colors">Automate (₹65,000 / $800)</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-slate-400 font-semibold">
              <li><Link href="/about" className="hover:text-yellow-400 transition-colors">About Us & Founder</Link></li>
              <li><a href="https://vishal-tiwari.me" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-400 transition-colors flex items-center space-x-1"><span>Portfolio (vishal-tiwari.me)</span></a></li>
          ...
          <div>
            ...
            <div className="space-y-2 text-xs text-slate-400 font-medium">
              <p>Email: <a href="mailto:vishal.buildss@gmail.com" className="text-yellow-400 font-bold hover:underline">vishal.buildss@gmail.com</a></p>
              <p>Portfolio: <a href="https://vishal-tiwari.me" target="_blank" rel="noopener noreferrer" className="text-yellow-400 font-bold hover:underline">vishal-tiwari.me</a></p>
              ...
              <div className="pt-2">
                <a
                  href="/#contact"
                  className="inline-block px-4 py-2 rounded-xl bg-yellow-400 text-black font-black text-xs uppercase tracking-wider shadow-sm hover:bg-yellow-300 transition-colors"
                >
                  Book 15-Min Audit
                </a>
              </div>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-400 space-y-4 sm:space-y-0 font-medium">
          <p>© {new Date().getFullYear()} vishal.buildss. All rights reserved. 100% Code Ownership Guaranteed.</p>
