              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-5">
                    ...
                    <span style={{ color: "var(--accent)" }} className="px-2.5 py-1 rounded-full bg-white text-[10px] font-semibold uppercase tracking-widest border border-[var(--border-default)]">
                      {item.badge}
                    </span>
                  </div>
